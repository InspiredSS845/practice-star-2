      ...
      lessons: [
        {
          ...
          "studentActivity": {
            ...
            "mission": "Earn practice stars by thinking through real-life choices about dignity, gifts, gratitude, humility, and service.",
            "reward": {
              "stars": 10
            },
            "steps": [
              {
                ...
                "prompt": "A classmate says, \"I am not good at sports, so I do not really matter on this team.\" Which response best protects their dignity?",
                "choices": ["Your worth is not measured by sports; your effort, attitude, and other strengths still matter here.", "Maybe your real strengths are somewhere else, so you do not need to worry about this team.", "If you practise enough, you will eventually matter to the team in the same way others do."],
                "correctAnswer": "Your worth is not measured by sports; your effort, attitude, and other strengths still matter here.",
                "feedback": "Yes. Dignity is not earned by being the best at one skill.",
                "hint": "Look for the answer that separates a person's worth from one ability."
              },
              {
                "kind": "question",
                "level": "Level 1: God-Given Dignity",
                "title": "Dignity and Difference",
                "prompt": "Which statement best explains how Christians can respect dignity while still noticing real differences?",
                "choices": ["Notice differences honestly while refusing to rank people's worth.", "Avoid mentioning differences because noticing them is usually disrespectful.", "Focus on people's strongest gifts first because those show their value most clearly."],
                "correctAnswer": "Notice differences honestly while refusing to rank people's worth.",
                "feedback": "Correct. Dignity does not require sameness, and differences should not become a ranking system.",
                "hint": "The best answer is honest about differences without using them to measure worth."
              },
              {
                "kind": "question",
                "level": "Level 1: God-Given Dignity",
                ...
                "choices": ["Gratitude for being made by God, together with respect for others.", "Confidence that God values me, so other people's opinions should not matter at all.", "A reminder that everyone is already complete, so growth is less important."],
                "correctAnswer": "Gratitude for being made by God, together with respect for others.",
                "feedback": "Right. The passage can lead to gratitude and respect, not pride or passivity.",
                "hint": "Choose the answer that keeps both gratitude and respect."
              },
              {
                "kind": "question",
                "level": "Level 1: God-Given Dignity",
                "title": "Jealousy Moment",
                "prompt": "You notice a classmate has a gift you wish you had. Which response shows dignity and maturity?",
                "choices": ["Appreciate what is good in their gift, then choose one next step for your own growth.", "Avoid thinking about their gift so comparison does not become a bigger problem.", "Work harder mainly so you can catch up and feel equal again."],
                "correctAnswer": "Appreciate what is good in their gift, then choose one next step for your own growth.",
                "feedback": "Yes. You can honour another person's gift without giving up on your own growth.",
              ...
              },
              {
                ...
                "prompt": "Which statement best balances thankfulness for gifts with a willingness to grow?",
                "choices": ["I can be thankful for strengths and still practise where I need to improve.", "I should spend most of my effort on weak areas so my gifts do not make me proud.", "I should focus mostly on my strongest gifts because they show where I can serve best."],
                "correctAnswer": "I can be thankful for strengths and still practise where I need to improve.",
              ...
              },
              {
                ...
                "level": "Level 2: Gifts and Strengths",
                "title": "Humility",
                "prompt": "Which answer best describes humility when someone has a real strength?",
                "choices": ["Being honest about the strength while using it with gratitude and care.", "Letting other people talk about the strength, but never naming it yourself.", "Focusing on weaker areas first so the strength does not become too important."],
                "correctAnswer": "Being honest about the strength while using it with gratitude and care.",
                "feedback": "Right. Humility is not pretending gifts do not exist; it is using them without pride.",
                "hint": "Think about whether humility means honesty or hiding."
              },
              {
                "kind": "question",
                "level": "Level 2: Gifts and Strengths",
                ...
                "feedback": "Yes. Helpful service respects the other person's dignity and learning.",
              ...
              },
              {
                ...
                "prompt": "Which reflection prompt is thoughtful but still privacy-safe?",
                ...
                "feedback": "Correct. It invites thought without forcing private sharing.",
                "hint": "Choose the prompt that asks for learning, not private disclosure."
              },
              {
                "kind": "question",
                ...
                "hint": "Look for service joined with humility."
              },
              {
                "kind": "question",
                "level": "Level 3: Using Gifts for Good",
              ...
              },
              {
                ...
                "prompt": "A teacher praises your work in front of the class. Which response shows gratitude and humility?",
              ...
              },
              {
                ...
                "choices": ["My worth is secure in God, and my gifts are for gratitude, growth, and service.", "My worth is secure in God, so my gifts mainly help me understand myself.", "My gifts are for service, so I should focus first on the areas where I am strongest."],
                "correctAnswer": "My worth is secure in God, and my gifts are for gratitude, growth, and service.",
                "feedback": "Correct. This brings together dignity, growth, gratitude, and service.",
            ...
            "questions": [
              {
                ...
                "prompt": "If people have God-given dignity, then differences in ability should be noticed with honesty but not used to measure a person's worth.",
                "choices": ["True", "False"],
                "correctAnswer": "True",
                "reviewNote": "Dignity does not depend on everyone having the same strengths."
              },
              {
                "type": "multipleChoice",
                "section": "God-Given Dignity",
                "prompt": "A student says, \"I am not special because I am not the best at anything.\" Which answer best fits this lesson?",
                "choices": ["Your worth is not measured by being the best; gifts can be quiet, growing, or used in small ways.", "You may feel better if you focus on a different activity where your strengths are easier to see.", "You can become more confident once you choose a skill and improve enough to stand out."],
                "correctAnswer": "Your worth is not measured by being the best; gifts can be quiet, growing, or used in small ways.",
                "reviewNote": "The lesson separates worth from performance and comparison."
              },
              {
                "type": "trueFalse",
                ...
                "choices": ["True", "False"],
                "correctAnswer": "False",
                "reviewNote": "Humility does not require pretending strengths are not real."
              },
              {
                "type": "multipleChoice",
                "section": "Gifts and Strengths",
                "prompt": "Which choice best shows stewardship of a gift?",
                ...
                "reviewNote": "Stewardship means using gifts responsibly and lovingly."
              },
              {
                "type": "multipleChoice",
                "section": "Gifts and Strengths",
                "prompt": "Which answer best explains Christian uniqueness in this lesson?",
                ...
                "reviewNote": "Uniqueness is connected to dignity, gratitude, and service."
              },
              {
                "type": "trueFalse",
                "section": "Using Gifts for Good",
                "prompt": "A gift used quietly can still be meaningful service, even if it does not receive attention.",
                "choices": ["True", "False"],
                "correctAnswer": "True",
                "reviewNote": "Quiet or unseen service can still matter."
              },
              {
                "type": "multipleChoice",
                "section": "Using Gifts for Good",
                "prompt": "You feel jealous of a classmate's gift. Which response best shows maturity?",
              ...
              },
              {
                ...
                "prompt": "A reflection can be meaningful without asking students to share private family details or prove the sincerity of their faith.",
                "choices": ["True", "False"],
                "correctAnswer": "True",
                "reviewNote": "The reflection should check thoughtfulness without forcing private disclosure."
              },
              {
                "type": "multipleChoice",
                "section": "Safe Reflection",
                "prompt": "Which reflection answer is most appropriate for this lesson?",
                ...
                "reviewNote": "A strong response names a gift and connects it to service without oversharing."
              },
              {
                "type": "multipleChoice",
                "section": "Lesson Summary",
                "prompt": "Which summary best captures the whole lesson?",
                "choices": ["My dignity is secure in God, and my gifts can grow and serve others.", "My dignity is secure in God, so discovering my gifts is mostly about self-confidence.", "My gifts can serve others best when I focus on the ones that come naturally."],
                "correctAnswer": "My dignity is secure in God, and my gifts can grow and serve others.",
                "reviewNote": "The lesson connects dignity, growth, gratitude, and service."
              }
            ]
          },
          reflectionPrompts: [
